...
class _CategoryPageState extends State<CategoryPage> {
  ...
  void initState() {
    ...
    _loadPermissions();
    _initProductCollection(); // Load the reference once on startup
  }

  // OPTIMIZATION: Load the collection reference once
  ...
  // Keeps your original tab logic if you need it elsewhere
  ...
  Widget _buildCategoryList() {
    // Wait for product Ref to load before building list
          ...
          builder: (context, snapshot) {
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                // OPTIMIZATION: Uses .count() aggregation.
                // This is much faster and doesn't download all product documents.
                return FutureBuilder<AggregateQuerySnapshot>(
                  ...
                  builder: (context, countSnapshot) {
                    final productCount =
                    countSnapshot.hasData ? countSnapshot.data!.count : 0;
  ...
  // --- Dialog Methods Below (Unchanged from your original logic) ---

  void _showAddExistingProductDialog(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final productName =
                                productData['itemName'] ?? 'Unknown';
                            final currentCategory =
                                productData['category'] ?? 'UnCategorised';
